    ...
    public static void main(String[] args){
        ...
        while(!input.equals("exit")){
            ...
            if(input.equals("catch") || input.equals("release")){
                ...
                try{selected = Monster.selectMonster(name);}
                catch(MonsterNotFoundException e){System.out.println(e);}
                catch(Exception e){System.out.println("Something went wrong.");}
            }
            
            switch(input){
                case "catch":
                    try{player.sureCapture(selected);}
                    catch(AlreadyCapturedException e){System.out.println(e);}
                    catch(FullTeamException e){System.out.println(e);}
                    catch(Exception e){System.out.println(e);}
                    break;
                case "release":
                    try{player.release(selected);}
                    catch(NotInTeamException e){System.out.println(e);}
                    catch(Exception e){System.out.println(e);}
                    break;
                case "exit":
                    break;
